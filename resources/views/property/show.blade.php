    ...
    <div class="container">
                ...
                @if(isset($properties))
                    <div id="{{$properties->id}}" class="col-sm-12 col-md-8 mt-3 alert alert-info">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 "><span>{{__('property.link_youtube')}} :  </span><button class="btn btn-primary"><a href="{{$properties->link_youtube}}" target="_blank">Youtube link</a></button> </div>
                    ...
                    <div class="co-sm-12 col-md-4 text-center contact mt-md-5">
                        <div >
                            <div class="mt-5 mb-3">
                                <button class="btn btn-primary w-75  show-number btn-lg"><i class="fas fa-phone"></i>{{__('property.show_number')}}</button>
                                <a class="btn btn-primary btn-lg number-phone mb-3 " href="tel:{{$properties->user->phone}}">{{$properties->user->phone}}</a>
                            </div>
                            <div class="mt-3">
                                <button class="btn btn-primary w-75 show-email btn-lg"><i class="fas fa-envelope-square"></i>{{__('property.show_email')}}</button>
                                <div class="mt-4"></div>
                                <a class="btn btn-primary email btn-lg mt-3 " href="mailto:{{$properties->user->email}}">{{$properties->user->email}}</a>
                            </div>
        ...
        <div class="container">
            ...
            <form class="add-comment">
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-success btn-add-comment" value="{{__('property.add_comment')}}" />
                </div>
            </form>
              @else
                <div class="text-primary text-center"> {{__('property.to_add_comment')}} <a class="btn btn-sm btn-primary" href="{{route('login')}}">{{__('property.login')}}</a></div>
            @endauth
        </div>
    </div>
